...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["marcus@mergington.edu", "alex@mergington.edu"]
    },
    "Tennis Club": {
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["eva@mergington.edu", "james@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop critical thinking and public speaking through competitive debate",
        "schedule": "Mondays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["benjamin@mergington.edu", "natalie@mergington.edu"]
    },
    "Science Club": {
